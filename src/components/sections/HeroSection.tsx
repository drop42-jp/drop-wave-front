...
const HeroSection = () => {
  return (
    <div className="relative bg-gradient-to-br from-blue-50 to-white py-8 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center">
          <p className="text-xl text-gray-600 mb-6 max-w-2xl mx-auto">
            Express Yourself with Unique, High-Quality T-Shirts That Tell Your Story
          </p>

          <div className="flex items-center justify-center space-x-6 text-sm text-gray-500">
            <div className="flex items-center space-x-1">
              <Shirt className="w-4 h-4 fill-blue-400 text-blue-400" />
